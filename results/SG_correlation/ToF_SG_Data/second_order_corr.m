...
addpath('../../../classes')
addpath('../../../input')
load('SG_2_tof_with_processing.mat')

condensate_length = 100; %microns
fine_pixnumz = 200;
coarse_pixnumz = 52;
fine_z_grid = linspace(-condensate_length/2, condensate_length/2, fine_pixnumz);
coarse_z_grid = linspace(-condensate_length/2, condensate_length/2, coarse_pixnumz);
%woc - without common phase
%referencing all profiles
for i = 1:1000
    cg_input_relative_phase(i,:) = cg_input_relative_phase(i,:) - cg_input_relative_phase(i, fine_pixnumz/2);
    ext_rel_phase_woc_10ms(i,:) = ext_rel_phase_woc_10ms(i,:) - ext_rel_phase_woc_10ms(i, coarse_pixnumz/2);
    ext_rel_phase_woc_15ms(i,:) = ext_rel_phase_woc_15ms(i,:) - ext_rel_phase_woc_15ms(i,coarse_pixnumz/2);
    ext_rel_phase_woc_20ms(i,:) = ext_rel_phase_woc_20ms(i,:) - ext_rel_phase_woc_20ms(i,coarse_pixnumz/2);
    ext_rel_phase_wc_10ms(i,:) = ext_rel_phase_woc_10ms(i,:) - ext_rel_phase_woc_10ms(i, coarse_pixnumz/2);
    ext_rel_phase_wc_15ms(i,:) = ext_rel_phase_woc_15ms(i,:) - ext_rel_phase_woc_15ms(i,coarse_pixnumz/2);
    ext_rel_phase_wc_20ms(i,:) = ext_rel_phase_woc_20ms(i,:) - ext_rel_phase_woc_20ms(i,coarse_pixnumz/2);
end
...
save('cov_SG_2_with_processing.mat', 'cov_woc_10ms', 'cov_woc_15ms', 'cov_woc_20ms',...
