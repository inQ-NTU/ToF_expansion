...
%hold on
histogram(integrated_contrast_wop_woc_short, 'BinWidth', 0.15, 'Normalization','pdf')
hold on
histogram(integrated_contrast_wp_woc_short, 'BinWidth',0.15, 'Normalization','pdf')
ylim([0,4])
xlim([0,2.5])
xticks([])
...
%hold on
histogram(integrated_contrast_wop_woc_medium, 'BinWidth', 0.15, 'Normalization','pdf')
hold on
histogram(integrated_contrast_wp_woc_medium, 'BinWidth',0.15, 'Normalization','pdf')
xlim([0,2])
xticks([])
%yticks([])
...
%hold on
histogram(integrated_contrast_wop_woc_long, 'BinWidth', 0.15, 'Normalization','pdf')
hold on
histogram(integrated_contrast_wp_woc_long, 'BinWidth',0.15, 'Normalization','pdf')
%ylim([0,3])
xlim([0,2.5])
xticks([])
yticks([0,0.3,0.6])
...
%histogram(integrated_contrast_in_short, 'BinWidth', 0.15, 'Normalization','pdf')
%hold on
histogram(integrated_contrast_wop_wc_short, 'BinWidth', 0.15, 'Normalization','pdf')
hold on
histogram(integrated_contrast_wp_wc_short, 'BinWidth',0.15, 'Normalization','pdf')
ylim([0,4])
xlim([0,2.5])
...
%histogram(integrated_contrast_in_medium, 'BinWidth', 0.15, 'Normalization','pdf')
%hold on
histogram(integrated_contrast_wop_wc_medium, 'BinWidth', 0.15, 'Normalization','pdf')
hold on
histogram(integrated_contrast_wp_wc_medium, 'BinWidth',0.15, 'Normalization','pdf')
%ylim([0,3])
xlim([0,2])
%yticks([])
...
%histogram(integrated_contrast_in_long, 'BinWidth', 0.15, 'Normalization','pdf')
%hold on
histogram(integrated_contrast_wop_wc_long, 'BinWidth', 0.15, 'Normalization','pdf')
hold on
histogram(integrated_contrast_wp_wc_long, 'BinWidth',0.15, 'Normalization','pdf')
xlabel('$\xi$', 'Interpreter','latex')
%ylim([0,3])
xlim([0,2.5])
yticks([0,0.3,0.6])
