...
axes(f(1))
plot(t_tof, fix_k_data_wop_woc*1e2, 'o-','Color', 'blue')
hold on
plot(t_tof, fix_k_data_wp_woc*1e2, 'x-', 'Color', 'red')
yline(mean(fix_k_data_in)*1e2)
ylim([0, 1])
yticks([0,0.5,1])
...
axes(f(2))
plot(t_tof, fix_k_data_wop_wc*1e2, 'o-', 'Color','blue')
hold on
plot(t_tof, fix_k_data_wp_wc*1e2, 'x-', 'Color', 'red')
yline(mean(fix_k_data_in)*1e2)
ylim([0, 1])
xlabel('$t\; \rm (ms)$', 'Interpreter', 'latex')
...
axes(f(3))
plot(k1, fourier_corr_in_15ms(6:20)*1e2,'-','Color','Black')
hold on
plot(k1, fourier_corr_wop_woc_15ms(6:20)*1e2,'o-', 'Color', 'Blue')
plot(k1, fourier_corr_wp_woc_15ms(6:20)*1e2,'x-', 'Color','Red')
...
plot(k1, fourier_corr_in_15ms(6:20)*1e2,'-','Color','Black')
hold on
plot(k1, fourier_corr_wop_wc_15ms(6:20)*1e2,'o-','Color','Blue')
plot(k1, fourier_corr_wp_wc_15ms(6:20)*1e2,'x-', 'Color', 'Red')
yticks([])
ylim([0,4])
xlim([0.35,1])
xlabel('$q\; (\rm \mu m^{-1})$', 'Interpreter', 'latex')
