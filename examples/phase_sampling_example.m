...
%generate 100 phase profiles samples - if the argument is empty, it will give 1 sample
nmb_samples = 100;
...
%Coarse-graining each sample to the size of 100
coarse_dim = 100;
...
figure
plot(fine_grid, all_samples(99,:))
hold on
plot(coarse_grid, coarse_samples(99,:),'o')
