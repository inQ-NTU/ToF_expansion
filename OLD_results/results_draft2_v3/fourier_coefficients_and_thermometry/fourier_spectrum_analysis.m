...
close all
addpath('../../input')
load('phase_extraction_and_fourier_spectrum_25nK_300samples.mat')
momentum_cutoff = 31;
...
load('phase_extraction_and_fourier_spectrum_35nK_300samples.mat')
...
load('phase_extraction_and_fourier_spectrum_50nK_300samples.mat')
...
load('phase_extraction_and_fourier_spectrum_75nK_300samples.mat')
...
load('phase_extraction_and_fourier_spectrum_60nK_300samples.mat')
...
plot(k, mean_fourier_amp_input_50nk(5:end),'Color','Black')
hold on
plot(k, mean_fourier_amp_woc_1_50nk(5:end), 'o-','Color', 'Blue','MarkerSize',3)
plot(k, mean_fourier_amp_woc_2_50nk(5:end), 'x-', 'Color', 'Red','MarkerSize',3)
plot(k, mean_fourier_amp_woc_3_50nk(5:end), '^-', 'Color', [0,0.7, 0], 'MarkerSize', 3)
plot(k, mean_fourier_amp_trans_50nk(5:end), '.', 'Color','Black')
xlim([0,1.5])
xticks([])
ax = gca;
ax.YAxis.Exponent= -2;
...
box on
plot(k, Delta_k_woc_1, 'o-', 'MarkerSize',2,'Color','Blue')
hold on
plot(k, Delta_k_woc_2,'x-','MarkerSize', 2, 'Color','Red')
plot(k, Delta_k_woc_3, '^-', 'MarkerSize', 2, 'Color', [0,0.7,0])
xlim([0,1.5])
ax = gca;
ax.YAxis.Exponent = -2;
...
plot(k,mean_fourier_amp_input_50nk(5:end),'Color','Black')
hold on
plot(k,mean_fourier_amp_wc_1_50nk(5:end), 'o-','Color','Blue', 'MarkerSize', 3)
plot(k,mean_fourier_amp_wc_2_50nk(5:end), 'x-', 'Color', 'Red', 'MarkerSize',3)
plot(k,mean_fourier_amp_wc_3_50nk(5:end), '^-','Color', [0,0.7,0], 'MarkerSize',3)
plot(k,mean_fourier_amp_trans_50nk(5:end), '.', 'Color','Black')
xlim([0,1.5])
ax = gca;
ax.YAxis.Exponent = -2;
...
box on
plot(k, Delta_k_wc_1, 'o-', 'MarkerSize',2,'Color','Blue')
hold on
plot(k, Delta_k_wc_2,'x-','MarkerSize', 2, 'Color','Red')
plot(k, Delta_k_wc_3, '^-', 'MarkerSize', 2, 'Color', [0,0.7,0])
xlim([0,1.5])
ax = gca;
ax.YAxis.Exponent = -2;
