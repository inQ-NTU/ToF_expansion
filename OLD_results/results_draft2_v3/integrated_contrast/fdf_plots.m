...
%Plotting
f = tight_subplot(2,3,[.08 .03],[.15 .05],[.1 .1]);
axes(f(1))
histogram(ic_in_1,'Normalization','pdf','BinWidth',0.2)
hold on
histogram(ic_woc_1_1,'Normalization','pdf','BinWidth',0.2)
...
axes(f(2))
histogram(ic_in_2,'Normalization','pdf','BinWidth',0.2)
hold on
histogram(ic_woc_1_2,'Normalization','pdf','BinWidth',0.2)
...
axes(f(3))
histogram(ic_in_3,'Normalization','pdf','BinWidth',0.2)
hold on
histogram(ic_wc_1_3,'Normalization','pdf','BinWidth',0.2)
...
histogram(ic_in_1,'Normalization','pdf','BinWidth',0.2)
hold on
histogram(ic_wc_1_1,'Normalization','pdf','BinWidth',0.2)
...
histogram(ic_in_2,'Normalization','pdf','BinWidth',0.2)
hold on
histogram(ic_wc_1_2,'Normalization','pdf','BinWidth',0.2)
