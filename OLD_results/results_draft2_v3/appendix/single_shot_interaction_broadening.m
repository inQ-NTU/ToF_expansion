...
interference_suite_wb = class_interference_pattern([rel_phase; com_phase], t_tof, intr_broaden_flag);

%full expansion (transversal and longitudinal)
rho_tof_full_wob = interference_suite_wob.tof_full_expansion();
rho_tof_full_wob = interference_suite_wob.normalize(rho_tof_full_wob, N_atoms);

rho_tof_full_wb = interference_suite_wb.tof_full_expansion();
rho_tof_full_wb = interference_suite_wb.normalize(rho_tof_full_wb, N_atoms);
