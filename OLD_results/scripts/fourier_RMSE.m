...
f(1) = subplot(1,3,1);
plot(linspace(0,n_cutoff-1, n_cutoff), rmse_trans_1,'o-','Color', 'blue')
hold on
plot(linspace(0,n_cutoff-1, n_cutoff), rmse_trans_2,'x-','Color', 'red')
plot(linspace(0,n_cutoff-1, n_cutoff), rmse_trans_3,'^-','Color',[0,0.7,0])
ylim([0,1.5])
...
f(2) = subplot(1,3,2);
plot(linspace(0,n_cutoff-1, n_cutoff), rmse_woc_1,'o-', 'Color','blue')
hold on
plot(linspace(0,n_cutoff-1, n_cutoff), rmse_woc_2,'x-','Color','red')
plot(linspace(0,n_cutoff-1, n_cutoff), rmse_woc_3,'^-','Color', [0,0.7,0])
ylim([0,1.5])
%yticks([0,0.2,0.4,0.6,0.8,1,1.2,1.4])
xlabel('$n$','Interpreter','latex')
...
f(3) = subplot(1,3,3);
plot(linspace(0,n_cutoff-1, n_cutoff), rmse_wc_1,'o-','Color', 'blue')
hold on
plot(linspace(0,n_cutoff-1, n_cutoff), rmse_wc_2,'x-', 'Color', 'red')
plot(linspace(0,n_cutoff-1, n_cutoff), rmse_wc_3,'^-','Color', [0,0.7,0])
ylim([0,1.5])
xlabel('$n$','Interpreter','latex')
...
save('fourier_RMSE_100nK_200points_200samples_no_1dconv.mat', 'all_input_fourier','all_trans_fourier_1', 'all_trans_fourier_2',...
