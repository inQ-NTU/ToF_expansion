...
img = figure;
f = tight_subplot(1,2,[0.12,0.1],[0.2, 0.2],[0.15, 0.15]);
...
hold off
xlabel('$F_{\varphi}$','Interpreter','latex')
ylabel('Probability','Interpreter','latex')
xlim([0.8,1])
title('(a)','FontName','Times','Color','black','Units', 'normalized','Interpreter','latex','Position',[-0.25,0.85]);
yticks([0,0.1,0.2,0.3])
ylim([0,0.35])

g(1) = axes('Position',[.19 .63 .09 .15] );
box on
histogram(delta_fidelities, 'Normalization','probability','FaceColor',"#EDB120",'BinWidth', 0.01)
xlabel('$\Delta F_{\varphi}$','Interpreter','latex')
xlim([-0.05,0.05])
...
ylb.Position(1) = ylb.Position(1)+0.5;
cb = colorbar;
clim([0,3])
