...
interference_suite1 = class_interference_pattern(phase_samples(1,:),t_tof);
interference_suite2 = class_interference_pattern(phase_samples,t_tof);
...
rho_tof3 = interference_suite2.convolution2d(rho_tof2, weak_convolution);
rho_tof4 = interference_suite2.convolution2d(rho_tof2, strong_convolution);
...
%extraction class
extraction_suite1 = class_phase_extraction(rho_tof1, t_tof);
extraction_suite2 = class_phase_extraction(rho_tof2, t_tof);
extraction_suite3 = class_phase_extraction(rho_tof3, t_tof);
extraction_suite4 = class_phase_extraction(rho_tof4, t_tof);
extraction_suite5 = class_phase_extraction(rho_tof5, t_tof);
extraction_suite6 = class_phase_extraction(rho_tof6, t_tof);
