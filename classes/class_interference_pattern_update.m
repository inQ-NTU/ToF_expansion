...
classdef class_interference_pattern_update < class_physical_parameters
    ...
    methods
        ...
        %% Constructor
        function obj = class_interference_pattern_update(phase_profile_all, density_profile_all, expansion_time, ...
        ...
        %Interpolating in situ mean density
        function density = get_insitu_density_1(obj, z)
            func = obj.profile_interpolation_init(obj.input_grid_z, obj.insitu_density_1);
            if func(z)>0
                density = func(z);
            else
                density = 0;
        ...
        function density = get_insitu_density_2(obj, z)
            func = obj.profile_interpolation_init(obj.input_grid_z, obj.insitu_density_2);
            if func(z)>0
                density = func(z);
            else
                density = 0;
